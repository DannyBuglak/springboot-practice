...
public class RegistrationController {
    ...
    public Registration update(@RequestBody Registration registration) {
        ...
        var existing = registrationRepository.findByTicketCode(ticketCode).orElseThrow(() -> new NoSuchElementException("Registration with ticket code " + ticketCode + " not found"));
